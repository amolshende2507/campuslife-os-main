  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-gradient-to-b from-background via-secondary/20 to-background">
      ...
      <div className="container-tight px-4 text-center">
        ...
        >
          Replace WhatsApp chaos and lost Google Forms with one beautiful platform.
          Events, Clubs, and Complaints—centralized.
        </motion.p>
        ...
        >
          {user ? (
            <Link to="/dashboard">
              <Button
                size="xl"
                variant="hero"
                className="w-full sm:w-auto h-12 px-8 text-base shadow-xl shadow-primary/20 transition-transform hover:-translate-y-1"
              >
                Go to Dashboard
          ...
          <Link to="/#features">
            <Button
              size="xl"
              variant="outline"
              className="w-full sm:w-auto h-12 px-8 text-base bg-white/50 backdrop-blur-sm border-2"
            >
              View Features
            </Button>
          </Link>
              ...
              <div className="w-16 sm:w-64 border-r bg-muted/10 p-4 hidden sm:flex flex-col gap-6">
                ...
                <div className="space-y-3">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div
                      key={i}
                      className={`flex items-center gap-3 p-2 rounded-lg ${i === 1 ? "bg-indigo-50 dark:bg-indigo-900/20" : ""
                        }`}
                    >
                      <div
                        className={`w-5 h-5 rounded ${i === 1
                            ? "bg-indigo-200 dark:bg-indigo-800"
                            : "bg-gray-200 dark:bg-gray-700"
                          }`}
                      />
                      <div
                        className={`h-2.5 rounded ${i === 1
                            ? "w-20 bg-indigo-200 dark:bg-indigo-800"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">
                  Admin fixed the "Broken Fan" issue.
                </p>
              </div>
            </div>
          </motion.div>
